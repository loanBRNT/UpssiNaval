...
public class Case {
    ...
    /**
     * Constructeur d'une Support.Case. Elle possède 4 attributs, 2 pour la surface et 2 autres en profondeur.
     */
    public Case(){
     ...
     * @return null s'il n'y en a pas, sinon Le Flotte.Navire qui l'occupe
     */
